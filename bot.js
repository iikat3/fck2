...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Rhelp|Rappelz shop'];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[Ahelp],`http://www.twitch.tv/barontube`);
    }, ms);
...
if (message.content.startsWith(prefix + 'Zhelp')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
